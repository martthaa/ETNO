...
namespace WebSite
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        protected void ddlCategory_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(CS))
            {
                SqlCommand cmd = new SqlCommand("select * from dblSubCategories where MainCatID='" + ddlCategory.SelectedItem.Value + "'", con);
                con.Open();
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                sda.Fill(dt);
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            //SqlConnection con = new SqlConnection("Data Source=DESKTOP-IRE1JF5\\SQLEXPRESS;Initial Catalog=MyDatabase;Integrated Security=True");
            //con.Open();
            //SqlCommand cmd = new SqlCommand("insert into tblProducts" + "(PName,PPrice,PSelPrice,PBrandID,PCategoryID,PSubCatID,PGender,PDescription, PProductDetails, PMaterialCare, FreeDelivery,30DayRet,COD) values (@PName,@PPrice,@PSelPrice,@PBrandID,@PCategoryID,@PSubCatID,@PGender,@PDescription, @PProductDetails, @PMaterialCare, @FreeDelivery,@30DayRet, @COD)", con);
