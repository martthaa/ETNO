<%@ Page Title="Cart" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="WebSite.WebForm10" %>
    ...
    <div style="padding-top:20px;">
            ...
            <asp:Repeater ID="rptrCartProducts" runat="server">
                ...
                <div class="media" style="border:1px solid #eaeaec">
                    ...
                    <div class="media-body">
                        ...
                        <span class="proPriceView"><%#Eval("PPrice","{0:0,00}") %></span>
                        <span class="proOgPriceView"><%#Eval("PSelPrice","{0:c}") %></span>
                        <p>
        ...
        <div class="col-md-3" runat="server" id="divPriceDetails">
            ...
            <div>
                ...
                <span class="pull-right priceGray" id="spanTotal"  runat="server"></span>
            </div>
            <div>
            ...
            <div>
               <div class="proPriceView">
                <label>Total</label>
                <span class="pull-right" id="spanCartTotal"  runat="server"></span>
            </div>
                <div>
